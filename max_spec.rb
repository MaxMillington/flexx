...
describe 'sorting csv things' do
  context 'when given a two line file' do
    ...
    it 'sorts two lines' do
      expect(reorder_sort(flex)).to eq(%w(undergoing_usda_exam customs_cleared departed_destination_port))
    end
  end
  context 'when given a three line file' do
    ...
    it 'sorts three lines' do
      expect(reorder_sort(flex)).to eq(%w(arrived_destination_port undergoing_usda_exam customs_cleared departed_destination_port))
    end
  end
  context 'when given a seven line file' do
    ...
    it 'sorts seven lines' do
      expect(reorder_sort(flex)).to eq(%w(sent_delivery_order_to_trucker trucker_confirmed_delivery_order delivery_scheduled arrived_destination_port undergoing_usda_exam customs_cleared departed_destination_port))
    end
  end
end
